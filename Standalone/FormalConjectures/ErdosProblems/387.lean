...
theorem erdos_387 : True ↔ ∃ c : ℝ, 0 < c ∧ ∀ n k : ℕ, 1 ≤ k → k < n →
...
theorem erdos_387.variants.schinzel : True ↔
...
theorem erdos_387.variants.guy : True ↔ ∀ c : ℝ, c < 1 → ∀ᶠ n : ℕ in atTop, ∀ k : ℕ, 1 ≤ k →
