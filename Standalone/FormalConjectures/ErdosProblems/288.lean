...
$$
-/
theorem erdos_288 : True ↔ Set.Finite { I : Fin 2 → ℕ+ × ℕ+ |
    ∀ j, (I j).1 ≤ (I j).2 ∧
...
-/
theorem erdos_288.variants.i2_card_eq_1 : True ↔ Set.Finite { (I, n₂) : (ℕ+ × ℕ+) × ℕ+ |
...
-/
theorem erdos_288.variants.k_intervals : True ↔ ∀ k, Set.Finite { I : Fin k → ℕ+ × ℕ+ |
    ∀ j, (I j).1 ≤ (I j).2 ∧
...
-/
theorem erdos_288.variants.exists_k_gt_2 : True ↔
