...
theorem green_40 : True ↔ Tendsto f atTop (𝓝 ⊤) := by
  sorry
...
theorem green_40.f_eq_one_for_all : True ↔ ∀ r, f r = 1 := by
  sorry

/-- It is not known whether f(2) = 1 [Gr24] -/
theorem green_40.f_two_eq_one : True ↔ f 2 = 1 := by
  sorry
...
theorem green_40.variants.arbitrary_subsets : True ↔ Tendsto f_tilde atTop (𝓝 ⊤) := by
  sorry
...
theorem green_40.variants.all_n : True ↔ Tendsto f_all atTop atTop := by
  sorry
