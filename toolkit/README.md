...
This dependency PR adds evidence publication to the review CLI. Proof workspace
commands follow in a separate PR. Publication qualification remains incomplete.
