...
This focused branch includes review and proof workspace commands. Evidence publication
arrives in its sibling PR; release-wheel examples install the combined fork candidate.
