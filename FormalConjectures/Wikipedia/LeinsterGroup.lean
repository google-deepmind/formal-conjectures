...
$$\sum_{H \leq G} |H| = |G|^2$$
-/
def IsLeinsterGroup (G : Type*) [Group G] [Fintype G] [DecidableEq G] : Prop :=
...
theorem leinster_group_conjecture :
    answer(sorry) ↔
      Set.Infinite {n : ℕ | ∃ (G : Type) (hG : Group G) (hF : Fintype G) (hD : DecidableEq G),
        @Fintype.card G hF = n ∧ @IsLeinsterGroup G hG hF hD} := by
  sorry
