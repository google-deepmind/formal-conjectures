...
lemma a_one : a 1 = 1 := by delta a; apply nth_of_forall; intro n' hn'; apply (check_cond_eq n').mpr; interval_cases n' <;> decide

@[category test, AMS 11]
lemma a_two : a 2 = 2 := by delta a; apply nth_of_forall; intro n' hn'; apply (check_cond_eq n').mpr; interval_cases n' <;> decide

@[category test, AMS 11]
lemma a_three : a 3 = 3 := by delta a; apply nth_of_forall; intro n' hn'; apply (check_cond_eq n').mpr; interval_cases n' <;> decide

@[category test, AMS 11]
lemma a_four : a 4 = 4 := by delta a; apply nth_of_forall; intro n' hn'; apply (check_cond_eq n').mpr; interval_cases n' <;> decide
