...
Solved in [FrKlMo25].
-/
@[category research formally solved using formal_conjectures at "https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/GreensOpenProblems/23.lean", AMS 5 11]
theorem green_23 :
  answer(True) ↔
