...
-/
@[category research formally solved using formal_conjectures at "https://github.com/google-deepmind/formal-conjectures/blob/main/FormalConjectures/Solution_470.lean", AMS 11]
...
theorem erdos_470.variants.smallest_weird_eq_70 : (∀ n < 70, ¬n.Weird) ∧ (70).Weird := by
  ...
  -- Unfold the definitions so `decide` can synthesize the Decidable instance
