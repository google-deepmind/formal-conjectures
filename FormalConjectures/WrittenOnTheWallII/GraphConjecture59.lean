...
example : residue (⊤ : SimpleGraph (Fin 2)) = 1 := by
  unfold residue SimpleGraph.residueAux SimpleGraph.havelHakimiStep SimpleGraph.degree SimpleGraph.neighborFinset
    SimpleGraph.neighborSetFintype SimpleGraph.Top.adjDecidable
