...
/--
For $k = 1$ (the first prime $p_1 = 2$, second prime $p_2 = 3$):
$\operatorname{lcm}(1, 2) = 2$ and $p_1 \cdot \operatorname{lcm}(1, 2) = 4$,
while $\operatorname{lcm}(1, 2) = 2 < 4$. This confirms the $k=1$ base case.
-/
