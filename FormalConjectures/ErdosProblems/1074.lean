...
lemma count_ehs_succ_mem {m : ℕ} (h : m ∈ EHSNumbers) : count (· ∈ EHSNumbers) (m + 1) = count (· ∈ EHSNumbers) m + 1 := by rw [Nat.count_succ]; simp [h]
lemma count_ehs_succ_not_mem {m : ℕ} (h : m ∉ EHSNumbers) : count (· ∈ EHSNumbers) (m + 1) = count (· ∈ EHSNumbers) m := by rw [Nat.count_succ]; simp [h]
lemma count_ehs_8 : count (· ∈ EHSNumbers) 8 = 0 := by
  rw [count_ehs_succ_not_mem not_ehs_7, count_ehs_succ_not_mem not_ehs_6, count_ehs_succ_not_mem not_ehs_5, count_ehs_succ_not_mem not_ehs_4, count_ehs_succ_not_mem not_ehs_3, count_ehs_succ_not_mem not_ehs_2, count_ehs_succ_not_mem not_ehs_1, count_ehs_succ_not_mem not_ehs_0, count_zero]
lemma nth_ehs_0 : nth (· ∈ EHSNumbers) 0 = 8 := by have := @nth_count (· ∈ EHSNumbers) _ 8 ehs_8; rwa [count_ehs_8] at this

lemma count_ehs_9 : count (· ∈ EHSNumbers) 9 = 1 := by
  rw [count_ehs_succ_mem ehs_8, count_ehs_succ_not_mem not_ehs_7, count_ehs_succ_not_mem not_ehs_6, count_ehs_succ_not_mem not_ehs_5, count_ehs_succ_not_mem not_ehs_4, count_ehs_succ_not_mem not_ehs_3, count_ehs_succ_not_mem not_ehs_2, count_ehs_succ_not_mem not_ehs_1, count_ehs_succ_not_mem not_ehs_0, count_zero]
lemma nth_ehs_1 : nth (· ∈ EHSNumbers) 1 = 9 := by have := @nth_count (· ∈ EHSNumbers) _ 9 ehs_9; rwa [count_ehs_9] at this
...
lemma nth_ehs_2 : nth (· ∈ EHSNumbers) 2 = 13 := by have := @nth_count (· ∈ EHSNumbers) _ 13 ehs_13; rwa [count_ehs_13] at this
...
lemma nth_ehs_3 : nth (· ∈ EHSNumbers) 3 = 14 := by have := @nth_count (· ∈ EHSNumbers) _ 14 ehs_14; rwa [count_ehs_14] at this
...
lemma nth_ehs_4 : nth (· ∈ EHSNumbers) 4 = 15 := by have := @nth_count (· ∈ EHSNumbers) _ 15 ehs_15; rwa [count_ehs_15] at this
...
lemma nth_ehs_5 : nth (· ∈ EHSNumbers) 5 = 16 := by have := @nth_count (· ∈ EHSNumbers) _ 16 ehs_16; rwa [count_ehs_16] at this
...
lemma nth_ehs_6 : nth (· ∈ EHSNumbers) 6 = 17 := by have := @nth_count (· ∈ EHSNumbers) _ 17 ehs_17; rwa [count_ehs_17] at this
...
lemma nth_pillai_0 : nth (· ∈ PillaiPrimes) 0 = 23 := by have := @nth_count (· ∈ PillaiPrimes) _ 23 pillai_23; rwa [c_23] at this
...
lemma nth_pillai_1 : nth (· ∈ PillaiPrimes) 1 = 29 := by have := @nth_count (· ∈ PillaiPrimes) _ 29 pillai_29; rwa [c_29] at this
...
lemma nth_pillai_2 : nth (· ∈ PillaiPrimes) 2 = 59 := by have := @nth_count (· ∈ PillaiPrimes) _ 59 pillai_59; rwa [c_59] at this
...
lemma nth_pillai_3 : nth (· ∈ PillaiPrimes) 3 = 61 := by have := @nth_count (· ∈ PillaiPrimes) _ 61 pillai_61; rwa [c_61] at this
...
lemma nth_pillai_4 : nth (· ∈ PillaiPrimes) 4 = 67 := by have := @nth_count (· ∈ PillaiPrimes) _ 67 pillai_67; rwa [c_67] at this
...
lemma nth_pillai_5 : nth (· ∈ PillaiPrimes) 5 = 71 := by have := @nth_count (· ∈ PillaiPrimes) _ 71 pillai_71; rwa [c_71] at this
