...
-/
def signDiffHom (m n : ℕ) : Equiv.Perm (Fin m) × Equiv.Perm (Fin n) →* ℤˣ :=
  (sign.comp (MonoidHom.fst _ _)) * (sign.comp (MonoidHom.snd _ _)).inv
...
\Gamma_{m \oplus n} = \{(\sigma_1, \sigma_2) \in \mathrm{S}_m \times \mathrm{S}_n :
  \mathrm{sgn}(\sigma_1) = \mathrm{sgn}(\sigma_2)\}
$$
has rank $2$, i.e., it is generated by two elements.
-/
...
/--
It is known that $\Gamma_{2 \oplus 2} \cong C_2$ has rank $1$.
-/
...
/--
It is known that $\Gamma_{3 \oplus 3}$ has rank $3$ (not $2$-generated).
-/
@[category research solved, AMS 20]
theorem conjecture_1.variants.rank_3_3 :
    ∃ g₁ g₂ g₃ : gammaSubgroup 3 3,
      Subgroup.closure {g₁, g₂, g₃} = ⊤ ∧
        ∀ h₁ h₂ : gammaSubgroup 3 3, Subgroup.closure {h₁, h₂} ≠ ⊤ := by
  sorry

/--
It is known that $\Gamma_{4 \oplus 3}$ has rank $3$ (not $2$-generated).
-/
@[category research solved, AMS 20]
theorem conjecture_1.variants.rank_4_3 :
    ∃ g₁ g₂ g₃ : gammaSubgroup 4 3,
      Subgroup.closure {g₁, g₂, g₃} = ⊤ ∧
        ∀ h₁ h₂ : gammaSubgroup 4 3, Subgroup.closure {h₁, h₂} ≠ ⊤ := by
  sorry

/--
It is known that $\Gamma_{4 \oplus 4}$ has rank $3$ (not $2$-generated).
-/
@[category research solved, AMS 20]
theorem conjecture_1.variants.rank_4_4 :
    ∃ g₁ g₂ g₃ : gammaSubgroup 4 4,
      Subgroup.closure {g₁, g₂, g₃} = ⊤ ∧
