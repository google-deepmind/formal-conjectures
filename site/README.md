...
Lean code uses Verso's existing tokens and hover information, styled by
`src/css/lean-syntax.css` following the
[Imperial lecture notes](https://github.com/ImperialCollegeLondon/IUM/blob/main/LectureNotes/LectureNotesMain.lean).
The theme maps VS Code Light+ colors to Verso's CSS variables and token classes.
