...
The original version of this file was written by Michael Lee.
...
/-!
The three declarations below are copied from the tangent-coordinate-change API used by the
upstream orientation file (mathlib4 PR #35376, commit
`b62010aaf6453b96d631b8e077f7b73bee1f6d1f`). They are included here because the project's pinned
mathlib release predates them.
-/

section TangentCoordChangeCompat
