...
`FormalConjecturesForMathlib.Definitions.Algebra.Homology.LinearDual` then identifies it with the singular
cohomology of `FormalConjecturesForMathlib.Definitions.AlgebraicTopology.SingularCohomology`, which is defined
