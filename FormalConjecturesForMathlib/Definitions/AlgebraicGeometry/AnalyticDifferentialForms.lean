...
`FormalConjecturesForMathlib.Mathlib.Analysis.NormedSpace.WedgeCovectors` and
`FormalConjecturesForMathlib.Lemmas.Analysis.Calculus.DifferentialForm.ExactWedge`.
