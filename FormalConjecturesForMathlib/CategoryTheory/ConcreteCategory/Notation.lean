...
#41810](https://github.com/leanprover-community/mathlib4/pull/41810), which introduces the notation,
and [`mathlib4` pull request
#41811](https://github.com/leanprover-community/mathlib4/pull/41811), which rolls it out across
Mathlib. It can be deleted once both land.
-/
